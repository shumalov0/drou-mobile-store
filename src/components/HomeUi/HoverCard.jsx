  ...
  return (
    ...
    <HoverCard openDelay={0} closeDelay={0}>
      ...
      <HoverCardTrigger className=" cursor-pointer flex items-center hover:text-my_red  font-bold text-my_gray_Text relative">
         <Link to='/'>
            <span className="absolute top-[-17px] left-[0] rounded-lg px-1 bg-my_red text-my_white text-[11px] before:absolute before:rotate-[50deg]   before:bg-my_red before:content-[''] before:bottom-[-0.8px] before:w-[5px] before:h-[5px] ">new</span>
         HOME
      ...
      <HoverCardContent >
         <ul className="flex items-center flex-col gap-5">
            {HomePage.map((pages)=>(
                <li className=" cursor-pointer"><Link to={pages.to}>{pages.title}</Link></li>
                ))}
         </ul>
      </HoverCardContent>
    </HoverCard>
    ...
    <HoverCard openDelay={0} closeDelay={0}>
      ...
      <Link to='/contact' className="  text-my_gray_Text cursor-pointer flex items-center hover:text-my_red  font-bold">CONTACT</Link>
