  ...
  return (
    <Sheet>
      ...
      <SheetContent side={"left"}>
        <SheetHeader>
          <SheetDescription>
            <div className="sheetHeader flex flex-col items-start gap-4 ">
              ...
              <div className="accordion w-full pb-5">
                <AccordionUi />
              </div>
              <div className="location py-5 border-y-[0.5px] border-my_dark_gray w-full gap-5 flex  flex-col">
