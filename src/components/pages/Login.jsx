    ...
    <>
      ...
      <div className="container mx-auto px-8 flex  items-center justify-center flex-col">
        <div className="LoginBox mt-[40px] mb-[20px] flex flex-col items-center px-[15px] py-[25px] max-w-[450px] w-full shadow-xl">
          ...
          <p className="text-my_gray_Text">Please login using account detail below.</p>
          ...
          <form onSubmit={handleSubmit(submitForm)} className=" flex items-center flex-col">
            ...
            <div className="inputBox flex items-start justify-between  ">
              ...
              <input className="bg-[#ebebeb] outline-none px-[15px] py-[5px] focus:bg-my_white focus:border focus:border-current focus:rounded "
                {...register("email", {
              ...
              />
              {errors.email && (
                <p className="error-message text-my_orange text-[13px] font-medium">{errors.email.message}</p>
              )}
              </div>
            </div>
            <div className="inputBox flex items-start justify-between   ">
              ...
              />
              {errors.password && (
                <p className="error-message text-my_orange text-[13px] font-medium">{errors.password.message}</p>
              )}
              </div>
            </div>
            </div>
            <button className="font-medium px-[30px] py-[12px] bg-my_orange  flex items-center justify-center rounded-3xl text-my_white mt-8" type="submit">Sign In</button>
          </form>
          <Link  className="mt-10 pt-6 border-t-[1px] border-[#3333] w-full text-center " to="/register">Create Account</Link>
        </div>
      </div>
    </>
  );
